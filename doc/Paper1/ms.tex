...
$\{a_i\}_{i=1}^N$	&	Errorbar multiplier for each data point & $\left\{\begin{array}{lr}\kappa_1, & b_i > f_{\rm bad}\\ \kappa_2, & b_i \leq f_{\rm bad}\end{array}\right.$\\
\hline
...
+ \delta_{ij}\left(a_i\sigma_i\right)^2
\end{eqnarray}
...
$\kappa_2$, and the badness variable for data point $i$.
